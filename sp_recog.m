...
[B_idx, B_cbook] = create_cbook('B.wav',576,3200,128,12,42);
%[y, fs] = audioread('B.wav');

[y, fs] = audioread('B.wav');

j = 0;
for i = 2:length(y(576:3200,1))  % Apply pre-emphasis - change 0.97 value to anything between 0.5 and 1.0
    y_premp(i) = y(i) - 0.97*y(i-1); 
end
